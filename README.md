...
> 本软件完全免费使用。微信搜索小程序《52中文编程》可以查看使用帮助。
...
- 启动弹窗：免费说明 + 赞赏码（`微信赞赏2.jpg`），右上角 × 或底部“关闭”可关，屏蔽开关已预留（`src/renderer/donate-suppress.ts`，下个版本实现）
...
├── 微信赞赏2.jpg              # 赞赏码原图（renderer 内另有一份打包用拷贝）
